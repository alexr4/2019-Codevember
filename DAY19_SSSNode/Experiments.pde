...
void init(PGraphics ctx) {
  ...
  albedo = loadImage(MEDIA.path + "Gold/albedo.png");
  normal = loadImage(MEDIA.path + "Gold/normal.png");
  specular = loadImage(MEDIA.path + "Gold/specular.jpg");
  displacement = loadImage(MEDIA.path + "Gold/displacement.jpg");
