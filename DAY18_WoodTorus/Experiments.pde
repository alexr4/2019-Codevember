...
void init(PGraphics ctx) {
  ...
  albedo = loadImage(MEDIA.path + "Wood/albedo.jpg");
  normal = loadImage(MEDIA.path + "Wood/normal.jpg");
  specular = loadImage(MEDIA.path + "Wood/specular.jpg");
  displacement = loadImage(MEDIA.path + "Wood/displacement.jpg");
