...
void main(){
  ...
  float normDistToCenter = ((nt-distToCenter)/sqrt(2.0)) * 6.5;
  // normDistToCenter = length(nst.x - normTime); 
  ...
  vec3 color = vec3(border) + 0.5 * (1.0 - border);
