...
void init(PGraphics ctx) {
  ...
  ramp = loadImage(MEDIA.path + "Wood/rampsimple.png");
  albedo = loadImage(MEDIA.path + "Wood02/albedo.jpg");
  normal = loadImage(MEDIA.path + "Wood02/normal.jpg");
  specular = loadImage(MEDIA.path + "Wood02/specular.jpg");
  displacement = loadImage(MEDIA.path + "Wood02/displacement.jpg");
